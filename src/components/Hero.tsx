...
const Hero = () => {
  return (
    <section
      className="relative min-h-[calc(100vh-72px)] flex items-end pt-16 pb-20 md:pt-20 md:pb-32 overflow-hidden"
    >
      {/* Background Image */}
      ...
      <div className="relative section-container">
        <div className="max-w-3xl">
          ...
          <div
            className="badge-live mb-8 animate-fade-in"
          ...
          <div className="animate-float hidden md:block">
            <a
              href="#about"
              className="text-foreground/50 hover:text-primary transition-colors inline-flex items-center gap-2"
            >
